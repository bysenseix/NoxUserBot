        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**NOXUSERBOT HATA RAPORU**\n"
                    link = "[Nox Destek Grubu](https://t.me/NoxDestek)"
                    text += "İsterseniz, bunu rapor edebilirsiniz"
                    text += f"- sadece bu mesajı buraya iletin {link}.\n"
                    text += "Hata bilgileri dışında hiçbir şey kayıt edilmez.\n"
